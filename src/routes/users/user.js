 ...
 *   post:
 *     summary: Crear directorio y archivo
 *     description: Crea un directorio para un usuario y un archivo dentro de ese directorio.
 *     tags:
 *       - Directorio
 *     parameters:
 *       - name: userName
 *         in: path
 *         description: Nombre del usuario para el cual se creará el directorio y archivo.
 *         required: true
 *         schema:
 *           type: string
 *       - name: nameDirectory
 *         in: body
 *         description: Nombre del directorio a crear.
 *         required: true
 *         schema:
 *           type: object
 *           properties:
 ...
 *     responses:
 *       200:
 *         description: Directorio y archivo creados exitosamente.
 *       400:
